...
2. See how an existing theme is done via `/usr/share/de-omarchy/themes/catppuccin`.
...
Never edit stock themes under `/usr/share/de-omarchy/themes/` — changes are lost
...
cp /usr/share/de-omarchy/themes/catppuccin/colors.toml ~/.config/omarchy/themes/catppuccin/
...
```bash
cp -r /usr/share/de-omarchy/themes/catppuccin ~/.config/omarchy/themes/catppuccin-custom
